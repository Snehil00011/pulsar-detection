...
class PulsarFeatureLab:
    ...
    def main(self,argv=None):
        ...
        args.dir=os.path.abspath("E:\\Coding\\ISRO_Pulsar_Project\\MedLat to HTRU1_HTRU2\\MedlatTrainingData\\pulsars")
        args.out=os.path.abspath("E:\\Coding\\ISRO_Pulsar_Project\\MedLat to HTRU1_HTRU2\\MedlatTrainingData\\outputs\\Tool\\output.csv")
        args.feature_type=6
        args.candidate_type=4
